...
namespace Dataacces.Repository
{
    public class Conn
    {
        ...
        public Conn(string user, string pass)
        {
            ...
            strOracle = "User Id=" + usuario + " ; Password=" + password + " ; Data Source = (DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521)) (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = orcl)));";
