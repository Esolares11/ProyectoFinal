    ...
    public class AccesoController : Controller
    {
     public string strOracle = "";
        ...
        public ActionResult Login(Usuario oUsuario)
        {
            ...
            strOracle = "User Id="+oUsuario.Nombre_Usuario+"; Password=" + oUsuario.Password + " ; Data Source = (DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521)) (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = orcl)));";
